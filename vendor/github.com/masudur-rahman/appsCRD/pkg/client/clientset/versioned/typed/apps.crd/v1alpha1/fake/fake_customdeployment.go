...
var customdeploymentsResource = schema.GroupVersionResource{Group: "apps.crd", Version: "v1alpha1", Resource: "customdeployments"}

var customdeploymentsKind = schema.GroupVersionKind{Group: "apps.crd", Version: "v1alpha1", Kind: "CustomDeployment"}
